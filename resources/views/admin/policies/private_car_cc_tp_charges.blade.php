...
<div class="row ">
    <h3 class="text-center">Private Car CC AND TP Rates  </h3>
    <div class="col-lg-12 margin-tb mx-auto ">
      ...
      <a href="{{route('admin.private_car.index')}}" class="btn btn-info">Go Back</a>
...
<table id="dtHorizontalExample" class="table table-striped  table-bordered table-dark ">
          ...
          @if ( isset($private_car_cc_tp_charges))
       
               <tbody>

                @foreach ($private_car_cc_tp_charges as $key =>  $data)
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                  ...
                  <form action="{{route('admin.private_car.cc_tp.store')}}"  method="POST" id="private_car_cc_tp_create" enctype="multipart/form-data" >
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                <form action="{{route('admin.private_car.cc_tp.store')}}"  method="POST" id="two_wheeler_update" enctype="multipart/form-data" >
                      @csrf                  
...
<script>
    ...
    $(document).ready( function(){
      ...
      $("#private_car_cc_tp_create").on('submit',function(e){
                 ...
                 success:function(data){
                  ...
                  console.log(data);
                      ...
                      if(data.status == 401){
                        ...
                        $('#private_car_cc_tp_create')[0].reset();
  ...
  $(document).on('click','.edit_policy',function(e){
      ...
      type:"GET",
      url:  "{{APP_PATH}}"+"admin/private-car/cc-tp/edit/"+rate_chart_id,
            ...
            if(response.status == 404){
                ...
                $('#edit_cc').val(response.private_car_cc_tp_data.cc);
                $('#edit_tp_one_year').val(response.private_car_cc_tp_data.tp_one_year );
                $('#edit_tp_three_year').val(response.private_car_cc_tp_data.tp_three_year );
                $('#edit_vehicle_basic_rate').val(response.private_car_cc_tp_data.vehicle_basic_rate );
...
$.ajax({
    ...
    type:"DELETE",
    url: "{{APP_PATH}}"+"admin/private-car/cc-tp/delete/"+policy_id,
