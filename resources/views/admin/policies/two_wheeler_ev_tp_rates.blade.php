...
<div class="row ">
    <h3 class="text-center">Two Wheeler KW  AND TP Rates  </h3>
...
<table id="dtHorizontalExample" class="table table-striped  table-bordered table-dark ">
          ...
          @if ( isset($two_wheeler_ev_kw_tp_data))
       
               <tbody>

                @foreach ($two_wheeler_ev_kw_tp_data as $key =>  $data)
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                  ...
                  <form action="{{route('admin.two_wheeler_ev.kw_tp.store')}}"  method="POST" id="two_wheeler_ev_kw_tp_create" enctype="multipart/form-data" >
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                <form action="{{route('admin.two_wheeler_ev.kw_tp.store')}}"  method="POST" id="two_wheeler_ev_update" enctype="multipart/form-data" >
                      @csrf                  
...
<script>
    ...
    $(document).ready( function(){
      ...
      $("#two_wheeler_ev_kw_tp_create").on('submit',function(e){
                 ...
                 success:function(data){
                  ...
                  console.log(data);
                      ...
                      if(data.status == 401){
                        ...
                        $('#two_wheeler_ev_kw_tp_create')[0].reset();
  ...
  $(document).on('click','.edit_policy',function(e){
      ...
      $.ajax({
      type:"GET",
      url:  "{{APP_PATH}}"+"admin/two-wheeler-ev/kw-tp/edit/"+rate_chart_id,
            ...
            if(response.status == 404){
                ...
                $('#edit_kw').val(response.two_wheeler_ev_kw_tp_data.kw);
                $('#edit_tp_one_year').val(response.two_wheeler_ev_kw_tp_data.tp_one_year );
                $('#edit_tp_five_year').val(response.two_wheeler_ev_kw_tp_data.tp_five_year );
...
$("#two_wheeler_ev_update").on('submit',function(e){
...
$.ajax({
    ...
    type:"DELETE",
    url: "{{APP_PATH}}"+"admin/two-wheeler-ev/kw-tp/delete/"+policy_id,
