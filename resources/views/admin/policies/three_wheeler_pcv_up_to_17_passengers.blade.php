...
<div class="row ">
    <h3 class="text-center text-uppercase">Basic Rates And Tp for  Three Wheeler PCV Up To 17 Passengers  </h3>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                  ...
                  <form action="{{route('admin.three_wheeler_pcv_upto_17_passengers.store')}}"  method="POST" id="three_wheeler_pcv_upto_17_create" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      <label for="image_order">Per Passenger Rate</label>
                      <input type="text" class="form-control" value="" min="0" name="per_passengers_rate" required>
                      <span class="text-danger error-text per_passengers_rate_error "></span>
                    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                <form action="{{route('admin.three_wheeler_pcv_upto_17_passengers.store')}}"  method="POST" id="goods_carrying_public_update" enctype="multipart/form-data" >
                      @csrf                  
                    ...
                    <!-- <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="image_order">Per Passenger Rate</label>
                        <input type="text" class="form-control" value="" name="per_passengers_rate" min="0" id="edit_per_passengers_rate" required>
                        <span class="text-danger error-text per_passengers_rate_error "></span>
                      </div>
...
<script>
    ...
    $(document).ready( function(){
      ...
      $("#three_wheeler_pcv_upto_17_create").on('submit',function(e){
                 ...
                 success:function(data){
                  ...
                  console.log(data);
                      ...
                      if(data.status == 401){
                        ...
                        $('#three_wheeler_pcv_upto_17_create')[0].reset();
  ...
  $(document).on('click','.edit_policy',function(e){
      ...
      type:"GET",
      url:  "{{APP_PATH}}"+"admin/three-wheeler-pcv-upto-17-passengers/edit/"+rate_chart_id,
            ...
            if(response.status == 404){
                ...
                $('#edit_policy_id').val(response.three_wheeler_pcv_upto_17_data.policy_id );
                $('#edit_zone').val(response.three_wheeler_pcv_upto_17_data.zone );
                $('#edit_age').val(response.three_wheeler_pcv_upto_17_data.age);
                $('#edit_vehicle_basic_rate').val(response.three_wheeler_pcv_upto_17_data.vehicle_basic_rate );
                $('#edit_vehicle_tp_rate').val(response.three_wheeler_pcv_upto_17_data.vehicle_tp_rate );
                $('#edit_per_passengers_rate').val(response.three_wheeler_pcv_upto_17_data.per_passengers_rate );
...
$.ajax({
    ...
    type:"DELETE",
    url: "{{APP_PATH}}"+"admin/three-wheeler-pcv-upto-17-passengers/delete/"+policy_id,
