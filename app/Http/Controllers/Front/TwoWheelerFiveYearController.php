        ...
        if($validator->fails()){
            ...
            return response()->json(['status' => 401 ,'error' => $validator->errors()->toArray() ]);
                    ...
                    $own_damage_premium=  [
                          ...
                          $restriccted_tppd =  ( $request->restriccted_tppd)? 250 : 0;

                    $liablity_premium = [

                        "basic_liability" => $cc_tp_charges->tp_five_year  ,
                        ...
                        "total_b" => ($cc_tp_charges->tp_five_year + $pa_to_owner_driver + $ll_to_paid_driver+ $pa_to_unnamed_passenger - $restriccted_tppd )
