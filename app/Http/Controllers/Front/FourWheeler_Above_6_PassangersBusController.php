    ...
    if($validator->fails()){
        ...
        return response()->json(['status' => 401 ,'error' => $validator->errors()->toArray() ]);
               ...
               // $zero_depreciation =  $request->zero_depreciation;
                ...
                $bus_tp_rate_additional = Four_wheeler_above_6_passengers_bus_tp_additional_rates::where('id',$request->no_of_passengers)->first();
                ...
                $own_damage_premium=  [
                    ...
                    //   $restriccted_tppd =  ( $request->restriccted_tppd == 1)? 150 : 0;
                      $passenger_coverage = ($bus_tp_rate_additional->other_bus_per_person * $request->no_of_passengers);
