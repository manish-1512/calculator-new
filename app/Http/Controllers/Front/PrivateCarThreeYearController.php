        ...
        if($validator->fails()){
            ...
            return response()->json(['status' => 401 ,'error' => $validator->errors()->toArray() ]);
                    ...
                    $own_damage_premium=  [
                          ...
                          $lpg_cng_for_liablity = ($request->lpg_cng_kit == 1) ?  60 * 3 :0;
                       

                    $liablity_premium = [

                        "basic_liability" => $cc_tp_charges->tp_three_year  ,
                        ...
                        "lpg_cng_kit" => $lpg_cng_for_liablity,
                                               
                        "total_b" => ($cc_tp_charges->tp_three_year + $pa_to_owner_driver + $ll_to_paid_driver+ $pa_to_unnamed_passenger + $lpg_cng_for_liablity - $restriccted_tppd )
